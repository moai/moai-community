...
copyhostfiles = function() 
    ...
    local files = MOAIFileSystem.listFiles( PITO_HOME..'host-templates/windows/vs2015')
	for k, entry in pairs ( files ) do
			local fullpath = string.format ( '%s/%s',PITO_HOME..'host-templates/windows/vs2015' , entry )
